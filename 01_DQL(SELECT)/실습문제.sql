...
SELECT (SYSDATE - TO_DATE(SUBSTR(EMP_NO, 1, 6)))
FROM EMPLOYEE;
...
SELECT SUM((SALARY*BONUS+SALARY)*12) AS "연봉합"
FROM EMPLOYEE
WHERE DEPT_CODE = 'D5';
...
--SELECT EXTRACT(YEAR FROM HIRE_DATE), NVL(COUNT(*),0)
--FROM EMPLOYEE
--GROUP BY EXTRACT(YEAR FROM HIRE_DATE)
--HAVING EXTRACT(YEAR FROM HIRE_DATE) BETWEEN 2001 AND 2004;
----HAVING EXTRACT(YEAR FROM HIRE_DATE) IN (2001,2002,2003,2004);
--
--SELECT DECODE(SUBSTR(HIRE_DATE, 1, 2), '01', '2001년', '02', '2002년'), COUNT(*)
--FROM EMPLOYEE
...
NVL(SUM(DECODE(TO_CHAR(EXTRACT(YEAR FROM HIRE_DATE)),'2001',1)),0) AS "2001년",
NVL(SUM(DECODE(TO_CHAR(EXTRACT(YEAR FROM HIRE_DATE)),'2002',1)),0) AS "2002년",
NVL(SUM(DECODE(TO_CHAR(EXTRACT(YEAR FROM HIRE_DATE)),'2003',1)),0) AS "2003년",
NVL(SUM(DECODE(TO_CHAR(EXTRACT(YEAR FROM HIRE_DATE)),'2004',1)),0) AS "2004년"
FROM EMPLOYEE;
