...
/*
    ...
    * 자료형
    ...
    > VARCHAR2 : 최대 4000바이트까지 지정 가능, 가변길이 (담긴 값에 따라서 공간의 크기 맞춰짐!)
...
DENT ON COLUMN MEMBER.EMAIL IS '이메일';
...
-- 각 컬럼 맞는 자료형 입력!
-- INSERT INTO MEMBER VALUES(1, 'user01', 'pass01', '홍길동'); 다 입력 안하면 에러발생
...
/*
    * UNIQUE
    ...
    삽입 / 수정 기존에 있는 데이터값 중 중복값이 있을 경우 오류 발생!
*/
...
-- ORA-00001: unique constraint (DDL.SYS_C007168) violated
--> UNIQUE 제약조건에 위배되었음! INSERT실패
--> 오류구문을 제약조건명으로 알려줌!! (특징 컬럼에 어떤문제가 있는지 상세히 알려주지 않음!)
--> 쉽게 파악하기 어려움!
...
CREATE TABLE MEM_UNIQUE( 
    MEM_NO NUMBER CONSTRAINT MEMNOM_NN NOT NULL,
...
INSERT INTO MEM_CHECK VALUES(2, 'user02', 'pass01', '이강인', 'ㄴ' , null, null);
-- ORA-02290: check constraint (DDL.SYS_C007178) violated
...
/*
    * PRIMARY KEY(기본키) 제약조건 => PK
    테이블 각 행들을 식별하기 위해 사용될 컬럼에 부여하는 제약조건 (식별자의 역할)
...
--> 기본키에 null을 담으려 할 때 (NOT NULL 제약조건 위반)
...
INSERT INTO TB_LIKE VALUES(1, '감자', SYSDATE); -- 에러발생!! 한번만 찜 가능
...
INSERT INTO MEM 
VALUES(3, 'user03', 'pass03', '이승우', '남', null, null, 40);
-- ORA-02291: integrity constraint (DDL.SYS_C007205) violated - parent key not found
INSERT INTO MEM 
