...
/*
    ...
    계정에게 시스템권한 객체 접근권한을 부여(GRANT)하거나 회수(REVOKE)하는 구문
...
-- 3_2. TABLESAPCE 할당 (SAMPLE 계정 변경
...
GRANT SELECT ON KH.EMPLOYEE TO SAMPLE; -- KH에 있는 EMPLOYEE테이블을 조회할 수 있는 권한을 SAMPLE에게 주겠다
...
/*
    ...
    RESOURCE : 특정한 객체들을 생성할 수 있는 권한 CREATE TABLE, CREATE SEQUENCE...
